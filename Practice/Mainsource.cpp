...
int main() {
    initgraph(); // Initialize graphics environment
    int x = 10;
    int y = 10;
    ...
    //int x = 100; // Initial x-coordinate of the circle
    //int y = 100; // Initial y-coordinate of the circle
    ...
    //    // Check if the circle goes beyond the screen boundaries
    //    if (x > getmaxx() || y > getmaxy()) {
    //        x = 100; // Reset x-coordinate
    //        y = 100; // Reset y-coordinate
    //    }
